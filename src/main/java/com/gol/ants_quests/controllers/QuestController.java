...
public class QuestController {
     ...
     * 
     * @GetMapping("/esiti")
     * public String esiti(@RequestParam HashMap<String, String> params, Model
     * model) {
     * 
     * if (params.containsKey("data_inizio") && params.containsKey("data_fine")) {
     * if (!params.get("data_inizio").isEmpty() &&
     * !params.get("data_fine").isEmpty()) {
     * showSrv.findByData(model, params.get("data_inizio"),
     * params.get("data_fine"));
     * 
     * } else
